...
int CVodeGetErrWeights(void *cvode_mem, FMIC_N_Vector eweight)
{
  CVodeMem cv_mem;
...
int CVodeGetEstLocalErrors(void *cvode_mem, FMIC_N_Vector ele)
{
  CVodeMem cv_mem;
