...
static int cvDenseSetup(CVodeMem cv_mem, int convfail, FMIC_N_Vector ypred,
                        FMIC_N_Vector fpred, booleantype *jcurPtr,
                        FMIC_N_Vector vtemp1, FMIC_N_Vector vtemp2, FMIC_N_Vector vtemp3);

static int cvDenseSolve(CVodeMem cv_mem, FMIC_N_Vector b, FMIC_N_Vector weight,
 ...
 *       test for compatible a compatible FMIC_N_Vector internal
 *       representation by checking that FMIC_N_VGetArrayPointer and
