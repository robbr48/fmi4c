 ...
 *     FMIC_N_Vectors which can be used by an IDADlsDenseJacFn routine 
...
typedef int (*IDADlsDenseJacFn)(long int N, realtype t, realtype c_j,
				FMIC_N_Vector y, FMIC_N_Vector yp, FMIC_N_Vector r, 
 ...
 *                                                                
 * tmp1, tmp2, tmp3 are pointers to memory allocated for          
 *     FMIC_N_Vectors which can be used by an IDADlsBandJacFn routine  
 *     as temporary storage or work space.                     
 *                                                                
...
typedef int (*IDADlsDenseJacFnB)(long int NeqB, realtype tt, realtype c_jB, 
				 ...
				 FMIC_N_Vector tmp1B, FMIC_N_Vector tmp2B, FMIC_N_Vector tmp3B);
...
typedef int (*IDADlsDenseJacFnBS)(long int NeqB, realtype tt, realtype c_jB, 
				 FMIC_N_Vector yy, FMIC_N_Vector yp,
				 FMIC_N_Vector *yS, FMIC_N_Vector *ypS,
				 FMIC_N_Vector yyB, FMIC_N_Vector ypB, FMIC_N_Vector rrB,
				 DlsMat JacB, void *user_dataB, 
				 FMIC_N_Vector tmp1B, FMIC_N_Vector tmp2B, FMIC_N_Vector tmp3B);
