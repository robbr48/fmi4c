 ...
 * type FMIC_N_Vector. The user_data parameter is the pointer user_data 
...
typedef int (*IDAResFn)(realtype tt, FMIC_N_Vector yy, FMIC_N_Vector yp,
			FMIC_N_Vector rr, void *user_data);
...
typedef int (*IDARootFn)(realtype t, FMIC_N_Vector y, FMIC_N_Vector yp,
...
typedef int (*IDAEwtFn)(FMIC_N_Vector y, FMIC_N_Vector ewt, void *user_data);
...
typedef int (*IDASensResFn)(int Ns, realtype t, 
			    FMIC_N_Vector yy, FMIC_N_Vector yp, FMIC_N_Vector resval,
			    FMIC_N_Vector *yyS, FMIC_N_Vector *ypS, 
                            FMIC_N_Vector *resvalS, void *user_data,
			    FMIC_N_Vector tmp1, FMIC_N_Vector tmp2, FMIC_N_Vector tmp3);
...
typedef int (*IDAQuadSensRhsFn)(int Ns, realtype t,
                               FMIC_N_Vector yy, FMIC_N_Vector yp, 
                               FMIC_N_Vector *yyS, FMIC_N_Vector *ypS, 
                               FMIC_N_Vector rrQ, FMIC_N_Vector *rhsvalQS,
                               void *user_data,
                               FMIC_N_Vector yytmp, FMIC_N_Vector yptmp, FMIC_N_Vector tmpQS);
...
typedef int (*IDAResFnB)(realtype tt, 
			 FMIC_N_Vector yy, FMIC_N_Vector yp,
			 FMIC_N_Vector yyB, FMIC_N_Vector ypB, 
                         FMIC_N_Vector rrB, void *user_dataB);

typedef int (*IDAResFnBS)(realtype t, 
                          FMIC_N_Vector yy, FMIC_N_Vector yp, 
                          FMIC_N_Vector *yyS, FMIC_N_Vector *ypS,
                          FMIC_N_Vector yyB, FMIC_N_Vector ypB,
                          FMIC_N_Vector rrBS, void *user_dataB);

typedef int (*IDAQuadRhsFnB)(realtype tt, 
                             FMIC_N_Vector yy, FMIC_N_Vector yp, 
                             FMIC_N_Vector yyB, FMIC_N_Vector ypB,
                             FMIC_N_Vector rhsvalBQ, void *user_dataB);

typedef int (*IDAQuadRhsFnBS)(realtype t, 
                              FMIC_N_Vector yy, FMIC_N_Vector yp,
                              FMIC_N_Vector *yyS, FMIC_N_Vector *ypS,
                              FMIC_N_Vector yyB, FMIC_N_Vector ypB,
                              FMIC_N_Vector rhsvalBQS, void *user_dataB);
/*
 * ================================================================
 ...
 *                      |                                          
 * IDASetId             | an FMIC_N_Vector, which states a given       
 ...
 *                      |                                         
 * IDASetConstraints    | an FMIC_N_Vector defining inequality         
...
SUNDIALS_EXPORT int IDASetId(void *ida_mem, FMIC_N_Vector id);
SUNDIALS_EXPORT int IDASetConstraints(void *ida_mem, FMIC_N_Vector constraints);
...
SUNDIALS_EXPORT int IDAInit(void *ida_mem, IDAResFn res,
                            realtype t0, FMIC_N_Vector yy0, FMIC_N_Vector yp0);
...
SUNDIALS_EXPORT int IDASVtolerances(void *ida_mem, realtype reltol, FMIC_N_Vector abstol);
 ...
 *       for FMIC_N_Vectors containing quadrature variables.           
 *                                                                
 *                                                                
 * ----------------------------------------------------------------
 */

SUNDIALS_EXPORT int IDAQuadInit(void *ida_mem, IDAQuadRhsFn rhsQ, FMIC_N_Vector yQ0);
SUNDIALS_EXPORT int IDAQuadReInit(void *ida_mem, FMIC_N_Vector yQ0);
...
SUNDIALS_EXPORT int IDAQuadSVtolerances(void *ida_mem, realtype reltolQ, FMIC_N_Vector abstolQ);
...
SUNDIALS_EXPORT int IDASensInit(void *ida_mem, int Ns, int ism, 
                                IDASensResFn resS,
                                FMIC_N_Vector *yS0, FMIC_N_Vector *ypS0);
 ...
 * ----------------------------------------------------------------
 */
SUNDIALS_EXPORT int IDASensReInit(void *ida_mem, int ism, FMIC_N_Vector *yS0, FMIC_N_Vector *ypS0);
...
SUNDIALS_EXPORT int IDASensSVtolerances(void *ida_mem, realtype reltolS, FMIC_N_Vector *abstolS);
 ...
 *
 * yQS    is an FMIC_N_Vector with initial values for sensitivities

 * -----------------------------------------------------------------
 */

SUNDIALS_EXPORT int IDAQuadSensInit(void *ida_mem, IDAQuadSensRhsFn resQS, FMIC_N_Vector *yQS0);
SUNDIALS_EXPORT int IDAQuadSensReInit(void *ida_mem, FMIC_N_Vector *yQS0);
...
SUNDIALS_EXPORT int IDAQuadSensSVtolerances(void *ida_mem, realtype reltolQS, FMIC_N_Vector *abstolQS);
 ...
 *                FMIC_N_Vector id was set through a call to IDASetId  
 ...
 *                                                                
 * Note: yret and ypret may be the same FMIC_N_Vectors as y0 and yp0   
...
SUNDIALS_EXPORT int IDASolve(void *ida_mem, realtype tout, realtype *tret,
			     FMIC_N_Vector yret, FMIC_N_Vector ypret, int itask);
...
SUNDIALS_EXPORT int IDAGetDky(void *ida_mem, realtype t, int k, FMIC_N_Vector dky);
...
SUNDIALS_EXPORT int IDAGetConsistentIC(void *ida_mem, FMIC_N_Vector yy0_mod, FMIC_N_Vector yp0_mod);
...
SUNDIALS_EXPORT int IDAGetErrWeights(void *ida_mem, FMIC_N_Vector eweight);
SUNDIALS_EXPORT int IDAGetEstLocalErrors(void *ida_mem, FMIC_N_Vector ele);
...
SUNDIALS_EXPORT int IDAGetQuad(void *ida_mem, realtype *t, FMIC_N_Vector yQout);
SUNDIALS_EXPORT int IDAGetQuadDky(void *ida_mem, realtype t, int k, FMIC_N_Vector dky);
/*
 * -----------------------------------------------------------------
...
SUNDIALS_EXPORT int IDAGetQuadErrWeights(void *ida_mem, FMIC_N_Vector eQweight);
 ...
 *   FMIC_N_Vector and must be allocated by the user to hold at least Ns
 *   vectors.
 *
...
SUNDIALS_EXPORT int IDAGetSens(void *ida_mem, realtype *tret, FMIC_N_Vector *yySout);
SUNDIALS_EXPORT int IDAGetSens1(void *ida_mem, realtype *tret, int is, FMIC_N_Vector yySret);

SUNDIALS_EXPORT int IDAGetSensDky(void *ida_mem, realtype t, int k, FMIC_N_Vector *dkyS);
SUNDIALS_EXPORT int IDAGetSensDky1(void *ida_mem, realtype t, int k, int is, FMIC_N_Vector dkyS);
...
SUNDIALS_EXPORT int IDAGetSensConsistentIC(void *ida_mem, FMIC_N_Vector *yyS0, FMIC_N_Vector *ypS0);
...
SUNDIALS_EXPORT int IDAGetSensErrWeights(void *ida_mem, FMIC_N_Vector_S eSweight);
...
SUNDIALS_EXPORT int IDAGetQuadSensErrWeights(void *ida_mem, FMIC_N_Vector *eQSweight);
...
SUNDIALS_EXPORT int IDAGetQuadSens(void *ida_mem, realtype *tret, FMIC_N_Vector *yyQSout);
SUNDIALS_EXPORT int IDAGetQuadSens1(void *ida_mem, realtype *tret, int is, FMIC_N_Vector yyQSret);

SUNDIALS_EXPORT int IDAGetQuadSensDky(void *ida_mem, realtype t, int k, FMIC_N_Vector *dkyQS);
SUNDIALS_EXPORT int IDAGetQuadSensDky1(void *ida_mem, realtype t, int k, int is, FMIC_N_Vector dkyQS);
...
SUNDIALS_EXPORT int IDAInitB(void *ida_mem, int which, IDAResFnB resB,
                             realtype tB0, FMIC_N_Vector yyB0, FMIC_N_Vector ypB0);
...
SUNDIALS_EXPORT int IDASVtolerancesB(void *ida_mem, int which, 
                                     realtype relTolB, FMIC_N_Vector absTolB);

SUNDIALS_EXPORT int IDAQuadInitB(void *ida_mem, int which, 
                                 IDAQuadRhsFnB rhsQB, FMIC_N_Vector yQB0);

SUNDIALS_EXPORT int IDAQuadInitBS(void *ida_mem, int which, 
                                  IDAQuadRhsFnBS rhsQS, FMIC_N_Vector yQB0);

SUNDIALS_EXPORT int IDAQuadReInitB(void *ida_mem, int which, FMIC_N_Vector yQB0);
...
SUNDIALS_EXPORT int IDAQuadSVtolerancesB(void *ida_mem, int which,
                                         realtype reltolQB, FMIC_N_Vector abstolQB);
 ...
 * components of y.  This option requires that the FMIC_N_Vector id was 
...
SUNDIALS_EXPORT int IDACalcICB (void *ida_mem, int which, realtype tout1,
                                FMIC_N_Vector yy0, FMIC_N_Vector yp0);

SUNDIALS_EXPORT int IDACalcICBS(void *ida_mem, int which, realtype tout1,
                                FMIC_N_Vector yy0, FMIC_N_Vector yp0,
                                FMIC_N_Vector *yyS0, FMIC_N_Vector *ypS0); 
...
SUNDIALS_EXPORT int IDASolveF(void *ida_mem, realtype tout, 
                              realtype *tret, 
                              FMIC_N_Vector yret, FMIC_N_Vector ypret, 
...
SUNDIALS_EXPORT int IDASetIdB(void *ida_mem, int which, FMIC_N_Vector idB);

SUNDIALS_EXPORT int IDASetConstraintsB(void *ida_mem, int which, 
                                       FMIC_N_Vector constraintsB);
...
SUNDIALS_EXPORT int IDAGetQuadB(void *ida_mem, int which, 
                                realtype *tret, FMIC_N_Vector qB);
...
SUNDIALS_EXPORT int IDAGetConsistentICB(void *ida_mem, int which, 
                                        FMIC_N_Vector yyB0, FMIC_N_Vector ypB0);
...
SUNDIALS_EXPORT int IDAGetAdjDataPointHermite(void *ida_mem, int which,
                                              realtype *t, FMIC_N_Vector yy, FMIC_N_Vector yd);
