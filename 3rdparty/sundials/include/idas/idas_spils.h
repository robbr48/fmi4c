 ...
 *
 * tmp1, tmp2, tmp3 are pointers to vectors of type FMIC_N_Vector
...
typedef int (*IDASpilsPrecSetupFn)(realtype tt,
				   FMIC_N_Vector yy, FMIC_N_Vector yp, FMIC_N_Vector rr,
 ...
 *     parameter passed to IDASetUserData.
 *
 * tmp is an FMIC_N_Vector which can be used by the PrecSolve
...
typedef int (*IDASpilsPrecSolveFn)(realtype tt,
				   FMIC_N_Vector yy, FMIC_N_Vector yp, FMIC_N_Vector rr,
				   FMIC_N_Vector rvec, FMIC_N_Vector zvec,
 ...
 *   rr   is the current value of the residual vector F(t,y,y').
 *
 *   v    is the FMIC_N_Vector to be multiplied by J.
 *
 *   Jv   is the output FMIC_N_Vector containing J*v.
 *
 ...
 *
 *   tmp1, tmp2 are two FMIC_N_Vectors which can be used by Jtimes for
 *         work space.
 * -----------------------------------------------------------------
 */
...
typedef int (*IDASpilsJacTimesVecFn)(realtype tt,
				     FMIC_N_Vector yy, FMIC_N_Vector yp, FMIC_N_Vector rr,
				     FMIC_N_Vector v, FMIC_N_Vector Jv,
				     realtype c_j, void *user_data,
				     FMIC_N_Vector tmp1, FMIC_N_Vector tmp2);
...
typedef int (*IDASpilsPrecSetupFnB)(realtype tt, 
				    ...
				    FMIC_N_Vector yyB, FMIC_N_Vector ypB, FMIC_N_Vector rrB, 
				    realtype c_jB, void *user_dataB,
				    FMIC_N_Vector tmp1B, FMIC_N_Vector tmp2B, 
				    FMIC_N_Vector tmp3B);
...
typedef int (*IDASpilsPrecSolveFnB)(realtype tt, 
				    FMIC_N_Vector yy, FMIC_N_Vector yp,
				    FMIC_N_Vector yyB, FMIC_N_Vector ypB, FMIC_N_Vector rrB, 
				    FMIC_N_Vector rvecB, FMIC_N_Vector zvecB,
				    realtype c_jB, realtype deltaB,
				    void *user_dataB, FMIC_N_Vector tmpB);
...
typedef int (*IDASpilsJacTimesVecFnB)(realtype t,
				      FMIC_N_Vector yy, FMIC_N_Vector yp,
				      FMIC_N_Vector yyB, FMIC_N_Vector ypB, FMIC_N_Vector rrB,
				      FMIC_N_Vector vB, FMIC_N_Vector JvB, 
				      realtype c_jB, void *user_dataB, 
				      FMIC_N_Vector tmp1B, FMIC_N_Vector tmp2B);
