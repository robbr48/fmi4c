...
typedef struct CVSpilsMemRec {
  ...
  FMIC_N_Vector s_ytemp;     /* temp vector passed to jtimes and psolve      */
  FMIC_N_Vector s_x;         /* temp vector used by CVSpilsSolve             */
  FMIC_N_Vector s_ycur;      /* CVODE current y vector in Newton Iteration   */
  FMIC_N_Vector s_fcur;      /* fcur = f(tn, ycur)                           */
...
int CVSpilsAtimes(void *cv_mem, FMIC_N_Vector v, FMIC_N_Vector z);

int CVSpilsPSolve(void *cv_mem, FMIC_N_Vector r, FMIC_N_Vector z, int lr);

/* Difference quotient approximation for Jac times vector */

int CVSpilsDQJtimes(FMIC_N_Vector v, FMIC_N_Vector Jv, realtype t,
                    FMIC_N_Vector y, FMIC_N_Vector fy, void *data,
                    FMIC_N_Vector work);
