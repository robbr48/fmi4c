...
-----------------------------------------------------------------
 ...
 NOTE: The ARKSUPERLUMT linear solver assumes a serial 
       ...
       ARKSuperLUMT will first test for a compatible FMIC_N_Vector
       internal representation by checking that the function
       FMIC_N_VGetArrayPointer exists.
---------------------------------------------------------------*/
...
-----------------------------------------------------------------
 ...
 NOTE: The ARKSUPERLUMT linear solver assumes a serial 
       ...
       FMIC_N_Vector internal representation by checking that the 
       function FMIC_N_VGetArrayPointer exists.
---------------------------------------------------------------*/
