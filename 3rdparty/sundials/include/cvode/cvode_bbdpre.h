...
typedef int (*CVLocalFn)(long int Nlocal, realtype t, FMIC_N_Vector y,
                         FMIC_N_Vector g, void *user_data);
...
typedef int (*CVCommFn)(long int Nlocal, realtype t, FMIC_N_Vector y,
                        void *user_data);
