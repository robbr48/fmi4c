 ...
 *     FMIC_N_Vectors which can be used by an CVSparseJacFn routine 
...
typedef int (*CVSlsSparseJacFnB)(realtype t, FMIC_N_Vector y, 
				 FMIC_N_Vector yB, FMIC_N_Vector fyB,
