...
typedef int (*CVRhsFn)(realtype t, FMIC_N_Vector y,
		       FMIC_N_Vector ydot, void *user_data);
...
typedef int (*CVRootFn)(realtype t, FMIC_N_Vector y, realtype *gout, void *user_data);
...
typedef int (*CVEwtFn)(FMIC_N_Vector y, FMIC_N_Vector ewt, void *user_data);
...
typedef int (*CVQuadRhsFn)(realtype t, FMIC_N_Vector y,
                           FMIC_N_Vector yQdot,
			   void *user_data);
...
typedef int (*CVSensRhsFn)(int Ns, realtype t,
			   FMIC_N_Vector y, FMIC_N_Vector ydot,
			   FMIC_N_Vector *yS, FMIC_N_Vector *ySdot,
			   void *user_data,
			   FMIC_N_Vector tmp1, FMIC_N_Vector tmp2);
...
typedef int (*CVSensRhs1Fn)(int Ns, realtype t,
			    FMIC_N_Vector y, FMIC_N_Vector ydot,
			    int iS, FMIC_N_Vector yS, FMIC_N_Vector ySdot,
			    void *user_data,
			    FMIC_N_Vector tmp1, FMIC_N_Vector tmp2);
...
typedef int (*CVQuadSensRhsFn)(int Ns, realtype t,
                               FMIC_N_Vector y, FMIC_N_Vector *yS, 
                               FMIC_N_Vector yQdot, FMIC_N_Vector *yQSdot,
                               void *user_data,
                               FMIC_N_Vector tmp, FMIC_N_Vector tmpQ);
...
typedef int (*CVRhsFnB)(realtype t, FMIC_N_Vector y,
			FMIC_N_Vector yB, FMIC_N_Vector yBdot,
			void *user_dataB);

typedef int (*CVRhsFnBS)(realtype t, FMIC_N_Vector y, FMIC_N_Vector *yS,
                         FMIC_N_Vector yB, FMIC_N_Vector yBdot,
                         void *user_dataB);

  
typedef int (*CVQuadRhsFnB)(realtype t, FMIC_N_Vector y,
			    FMIC_N_Vector yB, FMIC_N_Vector qBdot,
			    void *user_dataB);

typedef int (*CVQuadRhsFnBS)(realtype t, FMIC_N_Vector y, FMIC_N_Vector *yS,
                             FMIC_N_Vector yB, FMIC_N_Vector qBdot,
                             void *user_dataB);
...
SUNDIALS_EXPORT int CVodeInit(void *cvode_mem, CVRhsFn f, realtype t0, FMIC_N_Vector y0);
SUNDIALS_EXPORT int CVodeReInit(void *cvode_mem, realtype t0, FMIC_N_Vector y0);
...
SUNDIALS_EXPORT int CVodeSVtolerances(void *cvode_mem, realtype reltol, FMIC_N_Vector abstol);
 ...
 *
 * yQ0   is an FMIC_N_Vector with initial values for quadratures
...
SUNDIALS_EXPORT int CVodeQuadInit(void *cvode_mem, CVQuadRhsFn fQ, FMIC_N_Vector yQ0);
SUNDIALS_EXPORT int CVodeQuadReInit(void *cvode_mem, FMIC_N_Vector yQ0);
...
SUNDIALS_EXPORT int CVodeQuadSVtolerances(void *cvode_mem, realtype reltolQ, FMIC_N_Vector abstolQ);
...
SUNDIALS_EXPORT int CVodeSensInit(void *cvode_mem, int Ns, int ism,
                                  CVSensRhsFn fS, FMIC_N_Vector *yS0);
SUNDIALS_EXPORT int CVodeSensInit1(void *cvode_mem, int Ns, int ism,
                                   CVSensRhs1Fn fS1, FMIC_N_Vector *yS0);
SUNDIALS_EXPORT int CVodeSensReInit(void *cvode_mem, int ism, FMIC_N_Vector *yS0);
...
SUNDIALS_EXPORT int CVodeSensSVtolerances(void *cvode_mem, realtype reltolS, FMIC_N_Vector *abstolS);
...
SUNDIALS_EXPORT int CVodeQuadSensInit(void *cvode_mem, CVQuadSensRhsFn fQS, FMIC_N_Vector *yQS0);
SUNDIALS_EXPORT int CVodeQuadSensReInit(void *cvode_mem, FMIC_N_Vector *yQS0);
...
SUNDIALS_EXPORT int CVodeQuadSensSVtolerances(void *cvode_mem, realtype reltolQS, FMIC_N_Vector *abstolQS);
...
SUNDIALS_EXPORT int CVode(void *cvode_mem, realtype tout, FMIC_N_Vector yout,
...
SUNDIALS_EXPORT int CVodeGetDky(void *cvode_mem, realtype t, int k, FMIC_N_Vector dky);
...
SUNDIALS_EXPORT int CVodeGetQuad(void *cvode_mem, realtype *tret, FMIC_N_Vector yQout);

SUNDIALS_EXPORT int CVodeGetQuadDky(void *cvode_mem, realtype t, int k, FMIC_N_Vector dky);
...
SUNDIALS_EXPORT int CVodeGetSens(void *cvode_mem, realtype *tret, FMIC_N_Vector *ySout);
SUNDIALS_EXPORT int CVodeGetSens1(void *cvode_mem, realtype *tret, int is, FMIC_N_Vector ySout);

SUNDIALS_EXPORT int CVodeGetSensDky(void *cvode_mem, realtype t, int k, FMIC_N_Vector *dkyA);
SUNDIALS_EXPORT int CVodeGetSensDky1(void *cvode_mem, realtype t, int k, int is, FMIC_N_Vector dky);
...
SUNDIALS_EXPORT int CVodeGetQuadSens(void *cvode_mem, realtype *tret, FMIC_N_Vector *yQSout);
SUNDIALS_EXPORT int CVodeGetQuadSens1(void *cvode_mem, realtype *tret, int is, FMIC_N_Vector yQSout);

SUNDIALS_EXPORT int CVodeGetQuadSensDky(void *cvode_mem, realtype t, int k, FMIC_N_Vector *dkyQS_all);
SUNDIALS_EXPORT int CVodeGetQuadSensDky1(void *cvode_mem, realtype t, int k, int is, FMIC_N_Vector dkyQS);
...
SUNDIALS_EXPORT int CVodeGetErrWeights(void *cvode_mem, FMIC_N_Vector eweight);
SUNDIALS_EXPORT int CVodeGetEstLocalErrors(void *cvode_mem, FMIC_N_Vector ele);
...
SUNDIALS_EXPORT int CVodeGetQuadErrWeights(void *cvode_mem, FMIC_N_Vector eQweight);
...
SUNDIALS_EXPORT int CVodeGetSensErrWeights(void *cvode_mem, FMIC_N_Vector *eSweight);
...
SUNDIALS_EXPORT int CVodeGetQuadSensErrWeights(void *cvode_mem, FMIC_N_Vector *eQSweight);
...
SUNDIALS_EXPORT int CVodeInitB(void *cvode_mem, int which,
                               CVRhsFnB fB,
                               realtype tB0, FMIC_N_Vector yB0);
...
SUNDIALS_EXPORT int CVodeQuadInitB(void *cvode_mem, int which,
                                     CVQuadRhsFnB fQB, FMIC_N_Vector yQB0);
SUNDIALS_EXPORT int CVodeQuadInitBS(void *cvode_mem, int which,
                                      CVQuadRhsFnBS fQBs, FMIC_N_Vector yQB0);
SUNDIALS_EXPORT int CVodeQuadReInitB(void *cvode_mem, int which, FMIC_N_Vector yQB0);
...
SUNDIALS_EXPORT int CVodeF(void *cvode_mem, realtype tout, FMIC_N_Vector yout,
...
SUNDIALS_EXPORT int CVodeGetB(void *cvode_mem, int which,
                              realtype *tBret, FMIC_N_Vector yB);
SUNDIALS_EXPORT int CVodeGetQuadB(void *cvode_mem, int which,
                                  realtype *tBret, FMIC_N_Vector qB);
...
SUNDIALS_EXPORT int CVodeGetAdjY(void *cvode_mem, realtype t, FMIC_N_Vector y);
...
SUNDIALS_EXPORT int CVodeGetAdjDataPointHermite(void *cvode_mem, int which,
                                                realtype *t, FMIC_N_Vector y, FMIC_N_Vector yd);
  
SUNDIALS_EXPORT int CVodeGetAdjDataPointPolynomial(void *cvode_mem, int which,
                                                   realtype *t, int *order, FMIC_N_Vector y);
