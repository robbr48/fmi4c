 ...
 *
 *  uscale  vector (type FMIC_N_Vector) containing diagonal elements
 *          of scaling matrix for vector uu [input]
 *
 *  fval  vector (type FMIC_N_Vector) containing result of nonliear
 *        system function evaluated at current iterate:
 *        fval = F(uu) [input]
 *
 *  fscale  vector (type FMIC_N_Vector) containing diagonal elements
...
typedef int (*KINSpilsPrecSetupFn)(FMIC_N_Vector uu, FMIC_N_Vector uscale,
                                   FMIC_N_Vector fval, FMIC_N_Vector fscale,
                                   void *user_data, FMIC_N_Vector vtemp1,
				   FMIC_N_Vector vtemp2);
...
typedef int (*KINSpilsPrecSolveFn)(FMIC_N_Vector uu, FMIC_N_Vector uscale, 
                                   FMIC_N_Vector fval, FMIC_N_Vector fscale, 
                                   FMIC_N_Vector vv, void *user_data,
                                   FMIC_N_Vector vtemp);
...
typedef int (*KINSpilsJacTimesVecFn)(FMIC_N_Vector v, FMIC_N_Vector Jv,
                                     FMIC_N_Vector uu, booleantype *new_uu, 
                                     void *J_data);
