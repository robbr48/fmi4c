 ...
 *
 *  q/d/v/p/u/r  vectors (type FMIC_N_Vector) used for workspace by
 *               the SPTFQMR algorithm
 *
 *  vtemp1/vtemp2/vtemp3  scratch vectors (type FMIC_N_Vector) used as
 *                        temporary storage
 * -----------------------------------------------------------------
 */
...
SUNDIALS_EXPORT SptfqmrMem SptfqmrMalloc(int l_max, FMIC_N_Vector vec_tmpl);
...
SUNDIALS_EXPORT int SptfqmrSolve(SptfqmrMem mem, void *A_data, FMIC_N_Vector x, FMIC_N_Vector b,
