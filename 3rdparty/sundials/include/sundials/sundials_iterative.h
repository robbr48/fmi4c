...
typedef int (*ATimesFn)(void *A_data, FMIC_N_Vector v, FMIC_N_Vector z);
...
typedef int (*PSolveFn)(void *P_data, FMIC_N_Vector r, FMIC_N_Vector z, int lr);
 ...
 * of the FMIC_N_Vector v[k] against the p unit FMIC_N_Vectors at           
 * v[k-1], v[k-2], ..., v[k-p].                                   
 *                                                                
 * v is an array of (k+1) FMIC_N_Vectors v[i], i=0, 1, ..., k.         
...
SUNDIALS_EXPORT int ModifiedGS(FMIC_N_Vector *v, realtype **h, int k, int p, 
 ...
 * orthogonalization of the FMIC_N_Vector v[k] against the p unit      
 * FMIC_N_Vectors at v[k-1], v[k-2], ..., v[k-p]. The parameters v, h, 
 * k, p, and new_vk_norm are as described in the documentation    
 * for ModifiedGS.                                                
 *                                                                
 * temp is an FMIC_N_Vector which can be used as workspace by the      
 * ClassicalGS routine.                                           
 *                                                                
...
SUNDIALS_EXPORT int ClassicalGS(FMIC_N_Vector *v, realtype **h, int k, int p, 
				realtype *new_vk_norm, FMIC_N_Vector temp, realtype *s);
